...
- [#129](https://github.com/dvashim/typescript-config/pull/129) [`6903573`](https://github.com/dvashim/typescript-config/commit/69035734dfcd201c1ff32ed5f954c9984ab4621d) - Update development dependencies
  
  - **Deps:** Bump `@biomejs/biome` to ^2.5.11, `@dvashim/biome-config` to ^1.16.0, `@types/node` to ^26.4.0, and `vite` to ^8.2.2
...
- [#123](https://github.com/dvashim/typescript-config/pull/123) [`d069fd9`](https://github.com/dvashim/typescript-config/commit/d069fd9c35f2e4efc1fcdafb90147ffd35d81364) - Update dev dependencies (Biome, Biome config, Changesets, publint) and bump pnpm to 11.22.0

## 5.0.5

### Patch Changes

- [#121](https://github.com/dvashim/typescript-config/pull/121) [`eb1c614`](https://github.com/dvashim/typescript-config/commit/eb1c6142d7e4c8feb290362130f0cdc1bab58223) - Upgrade release tooling to Changesets v3 and harden the CI workflows
...
- [#110](https://github.com/dvashim/typescript-config/pull/110) [`c868e5c`](https://github.com/dvashim/typescript-config/commit/c868e5c5fa4360dd760023d3dd51f6ed3e591e5d) - Improve README navigation and links, and update dev dependencies
